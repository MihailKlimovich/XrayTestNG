...
public class LoginPageForScratchOrg {
    ...
    private static final String USERNAME = "test-lbafgbxunsgq@example.com";//test-qcud2ypdbztz@example.com
    private static final String PASSWORD = "9EU3j&PDvJ@1l";//4EcH4cUgF)(9s
