...
public class QuoteMeetingPackages extends BasePage {
    ...
    By NEW_MEETING_PACKAGES = By.xpath("//span[text()='Meeting Rooms']/following::div[@title='New']");
    ...
    public void createMeetingPackages(String pack, String startDate, String endDate) throws InterruptedException {
        ...
        Thread.sleep(2000);
        wait1.until(ExpectedConditions.presenceOfElementLocated(PACKAGE_FIELD)).click();
