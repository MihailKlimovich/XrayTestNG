...
public class MEWSavailabilityBlock extends BaseTest {
    ...
    public void case5() throws InterruptedException, IOException {
        ...
        Assert.assertEquals(mAdjustmentStartUTC.get(0), date.generateTodayDate2_plus(0, 2) + "T11:00:00.000+0000");
        Assert.assertEquals(mAdjustmentStartUTC.get(1), date.generateTodayDate2_plus(0, 2) + "T11:00:00.000+0000");
        Assert.assertEquals(mAdjustmentStartUTC.get(2), date.generateTodayDate2_plus(0, 2) + "T11:00:00.000+0000");
        Assert.assertEquals(mAdjustmentQuantity.get(2).intValue(), -5);
        Assert.assertEquals(mAdjustmentEndUTC.get(0), date.generateTodayDate2_plus(0, 4) + "T13:30:00.000+0000");
        Assert.assertEquals(mAdjustmentEndUTC.get(1), date.generateTodayDate2_plus(0, 5) + "T13:30:00.000+0000");
        Assert.assertEquals(mAdjustmentEndUTC.get(2), date.generateTodayDate2_plus(0, 4) + "T13:30:00.000+0000");
    }
