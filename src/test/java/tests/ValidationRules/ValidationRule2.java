...
public class ValidationRule2 extends BaseTest {
    ...
    public void testCreateItem() throws InterruptedException, IOException {
        ...
        items.deleteItemSFDX(SFDX, "thn__Mews_Id__c=987", ORG_USERNAME);
        SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
        ...
        StringBuilder itemResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__Item__c",
                "-v",
                "thn__Reservation__c='" + reservationID + "' thn__Product__c='" + productRoom1NightID + "' thn__Mews_Id__c=987 thn__Send_to_Mews__c=true",
                "-u",
                ORG_USERNAME,
                "--json"});
