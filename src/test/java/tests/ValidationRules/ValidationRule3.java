...
public class ValidationRule3 extends BaseTest {

    @Test(priority = 1, description="Setting up validation rules")
    @Severity(SeverityLevel.NORMAL)
    @Description("Setup.thn__ByPass__c.thn__ByPassVR__c == false User.thn__ByPassVR__c == true")
    @Story("Settings")
    ...
    public void testCreateNewMyceQuote1() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test59'", ORG_USERNAME);
        SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test59' thn__Commissionable__c=true",
                "-u",
                ORG_USERNAME,
                "--json"});
        StringBuilder res = SfdxCommand.runLinuxCommand1(new String[]{
        ...
        Assert.assertEquals(name, "Test59");
    ...
    public void testCreateNewMyceQuote2() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test60'", ORG_USERNAME);
        SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:create",
                "-s",
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test60' thn__Commissionable__c=true thn__Commission_to__c='Agent'",
                "-u",
                ORG_USERNAME,
                "--json"});
        StringBuilder res = SfdxCommand.runLinuxCommand1(new String[]{
        ...
        Assert.assertEquals(name, "Test60");
        Assert.assertEquals(commissionable, "true");
    ...
    public void testCreateNewMyceQuote3() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test61'", ORG_USERNAME);
        SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:create",
                "-s",
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test61' thn__Commissionable__c=true thn__Commission_to__c='Company'",
                "-u",
                ORG_USERNAME,
                "--json"});
        StringBuilder res = SfdxCommand.runLinuxCommand1(new String[]{
        ...
        Assert.assertEquals(name, "Test61");
        Assert.assertEquals(commissionable, "true");
    ...
    public void testCreateNewMyceQuote4() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test62'", ORG_USERNAME);
        SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:create",
                "-s",
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test62' thn__Arrival_Date__c=" + date.generateTodayDate2() + " thn__Departure_Date__c=" +
        ...
        Assert.assertEquals(name, "Test62");
    ...
    public void testCreateNewMyceQuote5() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test63'", ORG_USERNAME);
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test63' thn__Company__c='" + testAgentID + "' thn__Agent__c='" + testCompanyID + "'",
                "-u",
                ORG_USERNAME,
                "--json"});
        StringBuilder res = SfdxCommand.runLinuxCommand1(new String[]{
        ...
        String company = JsonParser2.getFieldValue(res.toString(), "thn__Company__c");
        String agent =  JsonParser2.getFieldValue(res.toString(), "thn__Agent__c");
        Assert.assertEquals(name, "Test63");
    ...
    public void testCreateNewMyceQuote6() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test64'", ORG_USERNAME);
        SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:create",
                "-s",
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test64' thn__SendToMews__c=true",
                "-u",
                ORG_USERNAME,
                "--json"});
        StringBuilder res = SfdxCommand.runLinuxCommand1(new String[]{
        ...
        Assert.assertEquals(name, "Test64");
    ...
    public void testCreateNewMyceQuote7() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test65'", ORG_USERNAME);
        SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:create",
                "-s",
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test65' thn__Stage__c='4 - Closed'",
                "-u",
                ORG_USERNAME,
                "--json"});
        StringBuilder res = SfdxCommand.runLinuxCommand1(new String[]{
        ...
        Assert.assertEquals(name, "Test65");
    ...
    public void testCreateNewMyceQuote8() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test66'", ORG_USERNAME);
        StringBuilder hotelRecord= hotel.getHotelSFDX(SFDX, "thn__Unique_Id__c='Demo'", ORG_USERNAME);
        String propertyID = JsonParser2.getFieldValue(hotelRecord.toString(), "Id");
        String quoteID = myceQuotes.createQuoteSFDX(SFDX, "Name='Test66' thn__Pax__c=5" +
        ...
        Assert.assertEquals(name, "Test66");
    ...
    public void testCreateNewCreditNoteLine() throws InterruptedException, IOException {
        ...
        StringBuilder res1 = SfdxCommand.runLinuxCommand1(new String[]{SFDX,
                "force:data:record:create",
                "-s",
                "thn__Credit_Note__c",
                "-v",
        ...
        StringBuilder result = SfdxCommand.runLinuxCommand1(new String[]{SFDX,
                "force:data:record:create",
                "-s",
    ...
    public void testCreateNewPackageLine1() throws InterruptedException, IOException {
        packages.deletePackageSFDX(SFDX, "Name='Test Package 7'", ORG_USERNAME);
        StringBuilder res1 = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__Package__c",
                "-v",
                "Name='Test Package 7' thn__Multi_Days__c=true thn__Hotel__c='" + propertyID + "'",
                "-u",
                ORG_USERNAME,
                "--json"});
        StringBuilder res2 = SfdxCommand.runLinuxCommand1(new String[]{
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "-v",
                "Name='Test Pack Line 8' thn__Package__c='" + packageID + "'",
                "-u",
                ORG_USERNAME,
                "--json"});
        StringBuilder res = SfdxCommand.runLinuxCommand1(new String[]{
        ...
        Assert.assertEquals(namePackageLine, "Test Pack Line 8");
        Assert.assertEquals(appliedDay, null);
        Assert.assertEquals(namePackage, "Test Package 7");
    ...
    public void testCreateNewPackageLine2() throws InterruptedException, IOException {
        packages.deletePackageSFDX(SFDX, "Name='Test Package 8'", ORG_USERNAME);
        StringBuilder res1 = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__Package__c",
                "-v",
                "Name='Test Package 8' thn__Multi_Days__c=false thn__Hotel__c='" + propertyID + "'",
                "-u",
                ORG_USERNAME,
                "--json"});
        StringBuilder res2 = SfdxCommand.runLinuxCommand1(new String[]{
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__Package_Line__c",
                "-v",
                "Name='Test Pack Line 9' thn__Package__c='" + packageID + "' thn__AppliedDay__c=25",
                "-u",
                ORG_USERNAME,
                "--json"});
        StringBuilder res = SfdxCommand.runLinuxCommand1(new String[]{
        ...
        String namePackageLine = JsonParser2.getFieldValue(res.toString(), "Name");
        String appliedDay = JsonParser2.getFieldValue(res.toString(), "thn__AppliedDay__c");
        Assert.assertEquals(namePackageLine, "Test Pack Line 9");
        Assert.assertEquals(appliedDay, "25");
        Assert.assertEquals(namePackage, "Test Package 8");
    ...
    public void testCreateNewPackageLine3() throws InterruptedException, IOException {
        packages.deletePackageSFDX(SFDX, "Name='Test Package 9'", ORG_USERNAME);
        //given
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__Package__c",
                "-v",
                "Name='Test Package 9' thn__Hotel__c='" + propertyID + "'",
                "-u",
                ORG_USERNAME,
                "--json"});
        StringBuilder res2 = SfdxCommand.runLinuxCommand1(new String[]{
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__Package_Line__c",
                "-v",
                "Name='Test Pack Line 10' thn__Package__c='" + packageID + "' thn__Type__c='Hotel Room' thn__Product__c='" + productID + "'",
                "-u",
                ORG_USERNAME,
                "--json"});
        StringBuilder res = SfdxCommand.runLinuxCommand1(new String[]{
        ...
        Assert.assertEquals(namePackageLine, "Test Pack Line 10");
        Assert.assertEquals(product, productID);
        Assert.assertEquals(namePackage, "Test Package 9");
    ...
    public void testCreateQuoteHotelRoom() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test67'", ORG_USERNAME);
        StringBuilder res1 = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test67' thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" + date.generateTodayDate2() +
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "-v",
                "Name='Test Hotel Room 2' thn__MYCE_Quote__c='" + myceQuoteID + "' thn__Arrival_Date_Time__c=" +
        ...
        Assert.assertEquals(nameHotelRoom, "Test Hotel Room 2");
    ...
    public void testCreateQuoteHotelRoom2() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test68'", ORG_USERNAME);
        StringBuilder res1 = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test68' thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
    ...
    public void testCreateQuoteHotelRoom3() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test69'", ORG_USERNAME);
        StringBuilder res1 = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test69' thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2_plus(0, 1) + " thn__Departure_Date__c=" +
    ...
    public void testCreateQuoteHotelRoom4() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test70'", ORG_USERNAME);
        StringBuilder res1 = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test70' thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2_plus(0, 1) + " thn__Departure_Date__c=" +
                        date.generateTodayDate2_plus(0, 3),
                "-u",
                ORG_USERNAME,
    ...
    public void testCreateQuoteHotelRoom5() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test71'", ORG_USERNAME);
        StringBuilder res1 = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test71' thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2_plus(0, 1) + " thn__Departure_Date__c=" +
                        date.generateTodayDate2_plus(0, 3),
                "-u",
                ORG_USERNAME,
    ...
    public void testCreateQuoteHotelRoom6() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test72'", ORG_USERNAME);
        StringBuilder hotelRecord= hotel.getHotelSFDX(SFDX, "thn__Unique_Id__c='Demo'", ORG_USERNAME);
        String propertyID = JsonParser2.getFieldValue(hotelRecord.toString(), "Id");
        ...
        String quoteID = myceQuotes.createQuoteSFDX(SFDX, "Name='Test72' thn__Pax__c=5" +
    ...
    public void testCreateQuoteMeetingsRoom1() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test73'", ORG_USERNAME);
        StringBuilder res1 = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test73' thn__Pax__c=10 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2_plus(0, 1) + " thn__Departure_Date__c=" +
                        date.generateTodayDate2_plus(0, 3),
                "-u",
                ORG_USERNAME,
    ...
    public void testCreateQuoteMeetingsRoom2() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test74'", ORG_USERNAME);
        StringBuilder res1 = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test74' thn__Pax__c=10 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2_plus(0, 1) + " thn__Departure_Date__c=" +
                        date.generateTodayDate2_plus(0, 3),
                "-u",
                ORG_USERNAME,
    ...
    public void testCreateQuoteMeetingsRoom3() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test75'", ORG_USERNAME);
        ...
        StringBuilder myseQuoteResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test75' thn__Pax__c=4 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
    ...
    public void testCreateQuotePackage1() throws InterruptedException, IOException {
        ...
        StringBuilder myseQuoteResult = SfdxCommand.runLinuxCommand1(new String[]{SFDX,
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test76' thn__Pax__c=10 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2() + " thn__Departure_Date__c=" + date.generateTodayDate2_plus(0, 3),
                "-u",
                ORG_USERNAME,
                "--json"});
    ...
    public void testCreateQuotePackage2() throws InterruptedException, IOException {
        packages.deletePackageSFDX(SFDX, "Name='Test Package 10'", ORG_USERNAME);
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test77'", ORG_USERNAME);
        StringBuilder propertyRecord = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        StringBuilder packageResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__Package__c",
                "-v",
                "Name='Test Package 10'  thn__Hotel__c='" + propertyID + "' thn__Discount_Max__c=15",
                "-u",
                ORG_USERNAME,
                "--json"});
        ...
        StringBuilder myseQuoteResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test77' thn__Pax__c=10 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2() + " thn__Departure_Date__c=" + date.generateTodayDate2_plus(0, 3),
                "-u",
                ORG_USERNAME,
                "--json"});
    ...
    public void testCreateQuotePackage3() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test78'", ORG_USERNAME);
        StringBuilder propertyRecord = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        StringBuilder myseQuoteResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test78' thn__Pax__c=10 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2() + " thn__Departure_Date__c=" + date.generateTodayDate2_plus(0, 3),
                "-u",
                ORG_USERNAME,
                "--json"});
    ...
    public void testCreateQuotePackage4() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test79'", ORG_USERNAME);
        StringBuilder propertyRecord = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        StringBuilder myseQuoteResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test79' thn__Pax__c=10 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2() + " thn__Departure_Date__c=" + date.generateTodayDate2_plus(0, 3),
                "-u",
                ORG_USERNAME,
                "--json"});
    ...
    public void testCreateQuotePackage5() throws InterruptedException, IOException {
        ...
        StringBuilder packageResult = SfdxCommand.runLinuxCommand1(new String[]{SFDX,
                ...
                "thn__Package__c",
                "-v",
                "Name='Test Package 11'  thn__Hotel__c='" + propertyID + "' thn__Start_Date__c=" +
        ...
        StringBuilder myseQuoteResult = SfdxCommand.runLinuxCommand1(new String[]{SFDX,
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test80' thn__Pax__c=10 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
    ...
    public void testCreateQuotePackage6() throws InterruptedException, IOException {
        packages.deletePackageSFDX(SFDX, "Name='Test Package 12'", ORG_USERNAME);
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test81'", ORG_USERNAME);
        StringBuilder propertyRecord = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        StringBuilder packageResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__Package__c",
                "-v",
                "Name='Test Package 12'  thn__Discount_Max__c=10 thn__Hotel__c='" + propertyID + "' thn__Start_Date__c=" +
        ...
        StringBuilder myseQuoteResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test81' thn__Pax__c=10 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2() + " thn__Departure_Date__c=" + date.generateTodayDate2_plus(0, 5),
                "-u",
                ORG_USERNAME,
                "--json"});
    ...
    public void testCreateQuoteProduct1() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test82'", ORG_USERNAME);
        StringBuilder propertyRecord = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        StringBuilder myseQuoteResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test82' thn__Pax__c=10 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2() + " thn__Departure_Date__c=" + date.generateTodayDate2_plus(0, 5),
                "-u",
                ORG_USERNAME,
                "--json"});
    ...
    public void testCreateQuoteProduct2() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test83'", ORG_USERNAME);
        StringBuilder propertyRecord = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        StringBuilder myseQuoteResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test83' thn__Pax__c=10 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2_plus(0, 1) + " thn__Departure_Date__c=" +
    ...
    public void testCreateQuoteProduct3() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test84'", ORG_USERNAME);
        StringBuilder propertyRecord = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        StringBuilder myseQuoteResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test84' thn__Pax__c=10 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2_plus(0, 1) + " thn__Departure_Date__c=" +
                        date.generateTodayDate2_plus(0, 5),
                "-u",
                ORG_USERNAME,
    ...
    public void testCreateQuoteProduct4() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test85'", ORG_USERNAME);
        StringBuilder propertyRecord = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        StringBuilder myseQuoteResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test85' thn__Pax__c=10 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2_plus(0, 1) + " thn__Departure_Date__c=" +
                        date.generateTodayDate2_plus(0, 5),
                "-u",
                ORG_USERNAME,
    ...
    public void testCreateQuoteProduct5() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test86'", ORG_USERNAME);
        StringBuilder propertyRecord = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        StringBuilder myseQuoteResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test86' thn__Pax__c=10 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
    ...
    public void testCreateQuoteProduct6() throws InterruptedException, IOException {
        myceQuotes.deleteQuoteSFDX(SFDX, "Name='Test87'", ORG_USERNAME);
        StringBuilder propertyRecord = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        StringBuilder myseQuoteResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__MYCE_Quote__c",
                "-v",
                "Name='Test87' thn__Pax__c=10 thn__Hotel__c='" + propertyID + "' thn__Arrival_Date__c=" +
                        date.generateTodayDate2() + " thn__Departure_Date__c=" +
                        date.generateTodayDate2_plus(0, 5),
                "-u",
                ORG_USERNAME,
    ...
    public void testCreateGuest() throws InterruptedException, IOException {
        guests.deleteGuestSFDX(SFDX, "thn__FirstName__c='JohnAutoTest5'", ORG_USERNAME);
        StringBuilder guestResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__Guest__c",
                "-v",
                "thn__FirstName__c='JohnAutoTest5' thn__Send_to_Mews__c=true",
                "-u",
                ORG_USERNAME,
                "--json"});
    ...
    public void testCreateItem() throws InterruptedException, IOException {
        ...
        StringBuilder rateResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__Rate__c",
                "-v",
                "Name='TestRateAuto3' thn__IsActive__c=true thn__IsPublic__c=true thn__Hotel__c='" + propertyID + "'",
                "-u",
                ORG_USERNAME,
                "--json"});
        ...
        StringBuilder guestResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__Guest__c",
                "-v",
                "thn__FirstName__c='JohnAutoTest6'",
                "-u",
                ORG_USERNAME,
                "--json"});
        String guestID = JsonParser2.getFieldValue(guestResult.toString(), "id");
    ...
    public void testCreateReservation() throws InterruptedException, IOException {
        guests.deleteGuestSFDX(SFDX, "thn__FirstName__c='TestVRGuest6'", ORG_USERNAME);
        StringBuilder propertyRecord = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        StringBuilder guestResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__Guest__c",
                "-v",
                "thn__FirstName__c='TestVRGuest6'",
                "-u",
                ORG_USERNAME,
                "--json"});
        String guestID = JsonParser2.getFieldValue(guestResult.toString(), "id");
    ...
    public void testCreateReservation2() throws InterruptedException, IOException {
        guests.deleteGuestSFDX(SFDX, "thn__FirstName__c='TestVRGuest7'", ORG_USERNAME);
        reservations.deleteReservationSFDX(SFDX, "thn__Mews_Id__c='12345'", ORG_USERNAME);
        StringBuilder propertyRecord = SfdxCommand.runLinuxCommand1(new String[]{
                SFDX,
                "force:data:record:get",
                "-s",
        ...
        StringBuilder guestResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__Guest__c",
                "-v",
                "thn__FirstName__c='TestVRGuest7'",
                "-u",
                ORG_USERNAME,
                "--json"});
        String guestID = JsonParser2.getFieldValue(guestResult.toString(), "id");
        StringBuilder reservationResult = SfdxCommand.runLinuxCommand1(new String[]{
                ...
                "thn__Hotel__c='" + propertyID + "' thn__Mews_Service__c=' " + serviceID +
                        ...
                        " thn__EndUtc__c=" + date.generateTodayDate2_plus(0, 5) +
                        " thn__AdultCount__c=2 thn__ChildCount__c=1 thn__RequestedCategory__c='" + roomTypeID +
                        "' thn__Pricing_Type__c='Rate pricing' thn__Rate__c='" + rateID + "' thn__Mews_Id__c='12345'",
                "-u",
                ORG_USERNAME,
                "--json"});
        String reservationID = JsonParser2.getFieldValue(reservationResult.toString(), "id");
