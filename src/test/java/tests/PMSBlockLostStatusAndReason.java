...
public class PMSBlockLostStatusAndReason extends BaseTest {
    ...
    public void case1() throws InterruptedException, IOException {
        ...
        StringBuilder hotelRoomRecord = product.getProductSFDX(SFDX, "Name='Hotel Room' thn__Hotel__c='" + propertyID + "'", thynkPackUserName);
        System.out.println(hotelRoomRecord);
        String productHotelRoomID= JsonParser2.getFieldValue(hotelRoomRecord.toString(), "Id");
        StringBuilder roomTypeDeluxeSingleRecord = roomType.getRoomTypeSFDX(SFDX, "Name='Deluxe Single' thn__Hotel__c='" + propertyID + "'", thynkPackUserName);
        String roomTypeDeluxeSingleID = JsonParser2.getFieldValue(roomTypeDeluxeSingleRecord.toString(), "Id");
        StringBuilder rateRecord = rate.getRateSFDX(SFDX, "Name='TEST RATE EXCLUDE TAX' thn__Hotel__c='" + propertyID + "'", thynkPackUserName);
        ...
        String quoteHotelRoomID = quoteHotelRoom.createQuoteHotelRoomSFDX(SFDX, "thn__MYCE_Quote__c='"
                ...
                thynkPackUserName);
        myceQuotes.updateQuoteSFDX(SFDX, "Id='"+ quoteID + "'", "thn__SendToPMS__c=true", thynkPackUserName);
        StringBuilder pmsBlockRecord = pmsBlock.getPMSBlockSFDX(SFDX, "thn__MYCE_Quote__c='" + quoteID + "'", thynkPackUserName);
