...
public class ValidationRuleTest1 extends BaseTest {
    ...
    @Test(priority = 6, description = "Myce_Quote__c.VR05_Dates")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 7, description = "Myce_Quote__c.VR27_Company_Agent_Type")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 9, description = "Myce_Quote__c.VR22_ClosedStatus")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 11, description = "Credit_Note_Line__c.Invoice_Line_Validation")
    @Severity(SeverityLevel.NORMAL)
    ...
    public void testCreateNewCreditNoteLine() throws InterruptedException {
        ...
        //then
        Assert.assertEquals(creditNoteLine.readErrorMessage2(), expectedMessage);
        creditNoteLine.closeWindow();
    }

    @Test(priority = 12, description = "Package_Line__c.VR30_IsMultidays")
    @Severity(SeverityLevel.NORMAL)
    ...
    public void testCreateNewPackageLine1() throws InterruptedException {
        ...
        //then
        Assert.assertEquals(packageLine.readErrorMessage2(), expectedMessage);
        packageLine.closeWindow();;
    }

    @Test(priority = 13, description = "Package_Line__c.VR31_IsNotMultidays")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 14, description = "Package_Line__c.VR29_Product_property")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 15, description = "Quote_Hotel_Room__c.VR06_Departure_after")
    @Severity(SeverityLevel.NORMAL)
    ...
    public void testCreateQuoteHotelRoom() throws InterruptedException {
        ...
        //then
        Assert.assertEquals(quoteHotelRoom.readErrorMessage3(), expectedMessage);
    ...
    public void testCreateQuoteHotelRoom2() throws InterruptedException {
        ...
        //then
        Assert.assertEquals(quoteHotelRoom.readErrorMessage2(), expectedMessage);
        quoteHotelRoom.closeWindow();
    }
    ...
    @Test(priority = 20, description = "Quote_Hotel_Room__c.VR15_Pax")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 23, description = "Quote_Meetings_Room__c.VR25_PackageDate")
    @Severity(SeverityLevel.NORMAL)
    ...
    public void testCreateQuoteMeetingsRoom3() throws InterruptedException, IOException {
        ...
        //Then
        Assert.assertEquals(expectedMessage, quoteMeetingRoom.readErrorMessage2());
        quoteMeetingRoom.closeWindow();
    }

    @Test(priority = 24, description = "Quote_Package__c.VR12_Dates_within_Quote_dates")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 25, description = "Quote_Package__c.VR14_Discount")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 26, description = "Quote_Package__c.VR18_Pax")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 27, description = "Quote_Package__c.VR33_QuotePackage_Account")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 28, description = "Quote_Package__c.VR34_QuotePackage_Dates")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 29, description = "Quote_Package__c.VR37_Max_Discount")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 30, description = "Quote_Product__c.VR08_Start_End_Date")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 31, description = "Quote_Product__c.VR11_Dates_within_Quote_dates")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 32, description = "Quote_Product__c.VR17_Pax")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 33, description = "Quote_Product__c.VR23_ServiceArea_date")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 34, description = "Quote_Product__c.VR26_PackageDate")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 35, description = "Quote_Product__c.VR36_Consumption_on_Package_Line")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 36, description = "Guest__c.VR01_guest_send_to_mews")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 37, description = "Item__c.VR02_item_send_to_mews")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 38, description = "Reservation__c.VR03_Reason_update")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 39, description = "Reservation__c.VR04_Cancellation_reason")
    @Severity(SeverityLevel.NORMAL)
