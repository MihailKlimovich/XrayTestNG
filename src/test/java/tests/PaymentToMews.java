...
public class PaymentToMews extends BaseTest {
    ...
    public void case1() throws InterruptedException, IOException {
        ...
        guests.deleteGuestSFDX(SFDX, "thn__LastName__c='PaymentAutoGuest'", ORG_USERNAME);
        ...
        String quoteID = myceQuotes.createQuoteSFDX(SFDX, "Name='PaymentToMewsAutoTest' thn__Pax__c=5" +
                ...
                ORG_USERNAME);
        String guestId= guests.createGuestSFDX(SFDX, "thn__LastName__c='PaymentAutoGuest' thn__Hotel__c='" +
        ...
        String paymentId = payment.createPaymentSFDX(SFDX, "thn__MYCE_Quote__c='" + quoteID + "'" +
                " thn__Guest__c='" + guestId + "' thn__Gross_Value__c=500 thn__Type__c='Cash'" +
