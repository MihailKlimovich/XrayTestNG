...
public class QuoteProductMeetingRoomInteractions extends BaseTest{
    ...
    public void preconditions() throws InterruptedException, IOException {
        ...
        Assert.assertEquals(quoteMeetingRoomStartTime, "01:45:00.000Z");
    ...
    public void case3() throws InterruptedException, IOException {
        ...
        String quoteMeetingRoomEndTime= JsonParser2.
                getFieldValue(quoteMeetingRoomRecord.toString(), "thn__End_Time__c");
        Assert.assertEquals(quoteMeetingRoomEndTime, "19:15:00.000Z");
        Assert.assertEquals(baverageEndTime, "19:00:00.000Z");
        Assert.assertEquals(dinerEndTime, "09:00:00.000Z");
        Assert.assertEquals(winesEndTime, "10:30:00.000Z");
        Assert.assertEquals(activityEndTime, "12:15:00.000Z");
    ...
    public void case4() throws InterruptedException, IOException {
        ...
        String quoteMeetingRoomEndTime= JsonParser2.
                getFieldValue(quoteMeetingRoomRecord.toString(), "thn__End_Time__c");
        Assert.assertEquals(quoteMeetingRoomEndTime, "18:45:00.000Z");
        Assert.assertEquals(baverageEndTime, "18:45:00.000Z");
        Assert.assertEquals(dinerEndTime, "09:00:00.000Z");
        Assert.assertEquals(winesEndTime, "10:30:00.000Z");
        Assert.assertEquals(activityEndTime, "12:15:00.000Z");
        Assert.assertEquals(equipmentEndTime, "19:00:00.000Z");
    ...
    public void case5() throws InterruptedException, IOException {
        ...
        String quoteMeetingRoomStartTime= JsonParser2.
                getFieldValue(quoteMeetingRoomRecord.toString(), "thn__Start_Time__c");
        Assert.assertEquals(dinerStartTime, "07:30:00.000Z");
    ...
    public void case6() throws InterruptedException, IOException {
        ...
        String quoteMeetingRoomStartTime= JsonParser2.
                getFieldValue(quoteMeetingRoomRecord.toString(), "thn__Start_Time__c");
        Assert.assertEquals(dinerStartTime, "07:45:00.000Z");
    ...
    public void case7() throws InterruptedException, IOException {
        ...
        String quoteMeetingRoomEndTime= JsonParser2.
                getFieldValue(quoteMeetingRoomRecord.toString(), "thn__End_Time__c");
        Assert.assertEquals(baverageEndTime, "19:30:00.000Z");
    ...
    public void case8() throws InterruptedException, IOException {
        ...
        String quoteMeetingRoomEndTime= JsonParser2.
                getFieldValue(quoteMeetingRoomRecord.toString(), "thn__End_Time__c");
        Assert.assertEquals(baverageEndTime, "19:15:00.000Z");
        Assert.assertEquals(quoteMeetingRoomEndTime, "19:15:00.000Z");
    }
}
